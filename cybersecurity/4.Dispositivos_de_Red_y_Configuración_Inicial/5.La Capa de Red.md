...
- **Mayor Espacio de Direcciones** - Las direcciones IPv6 se basan en direcciones jerárquicas de 128 bits en lugar de IPv4 con 32 bits.
...
![[Pasted image 20260306143411.png]]
...
![[Pasted image 20260306143727.png]]
...
![[Pasted image 20260306144841.png]]
...
![[Pasted image 20260306144939.png]]
...
**5.3.6 Verifique su Comprensión - Paquete IPv6**

Pregunta 1

¿Cuáles son las tres opciones principales problemas asociados con IPv4? (Elija tres opciones).

*Agotamiento de direcciones IP, mayor complejidad de la red y expansión de la tabla de enrutamiento de Internet, falta de conectividad de extremo a extremo. IPv4 se estandarizó en la década de 1980 y tiene varias limitaciones tecnológicas, como la falta de conectividad de extremo a extremo y un espacio de direcciones agotado.*

Pregunta 2

¿Cuáles dos opciones son mejoras proporcionadas por IPv6 en comparación con IPv4? (Elija dos opciones).

*Hay varias mejoras técnicas realizadas en IPv6, dos de las cuales son un grupo de direcciones IP mucho más grande y un encabezado de protocolo simplificado.*

Pregunta 3

¿Qué es verdadero para el encabezado IPv6? (Elija dos opciones).
...
*Varios campos del encabezado IPv6 reemplazaron los campos del encabezado IPv4. Por ejemplo, el campo Límite de saltos reemplazó al campo Tiempo de vida del encabezado IPv4.*

## 5.4 Resumen de La Capa de Red
